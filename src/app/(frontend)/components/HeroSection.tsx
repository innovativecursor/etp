...
const HeroSection = () => {
  ...
  return (
    ...
    <section className="relative">
      <div className="flex justify-between sm:flex-row sm:gap-0 gap-12 flex-col items-center">
        <div className="sm:w-[40%] w-full mx-auto  sm:h-[40vw] flex flex-col justify-center items-center ">
          <motion.div
          ...
          >
            <motion.h1
              className="text-[4vw]  font-wix-madefor tracking-wide font-bold leading-tight"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.2, duration: 0.8 }}
              viewport={{ once: false, amount: 0.3 }}
            ...
            <div className="w-3/4">
              <motion.p
                className="text-[#A3A3A3] tracking-wide leading-6 font-light text-[2vw] lg:text-base"
                initial={{ opacity: 0 }}
                whileInView={{ opacity: 1 }}
                transition={{ delay: 0.4, duration: 0.8 }}
                viewport={{ once: false, amount: 0.3 }}
        ...
        <div className="sm:w-[55%] w-full relative  h-[40vw] ">
          <Image
            src={data?.desktopImage?.url || heroImage}
            alt="Modern Home"
            className="object-cover"
